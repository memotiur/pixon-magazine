...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box">
                <h4 class="m-t-0 header-title">Update User</h4>
                <hr>
                        ...
                        <div class="p-20">
                            <form class="form-horizontal" method="post" action="/user/update"
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <select class="form-control" name="user_type">
                                            ...
                                            <option value="2" @if($result->user_type==2)selected @endif>Author</option>
                                            <option value="3" @if($result->user_type==3)selected @endif>User</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea type="text" class="form-control" name="biography">{{ $result->biography }}</textarea>
