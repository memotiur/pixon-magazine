    ...
    <form class="form-horizontal" method="POST" action="/post/update" enctype="multipart/form-data">
                            ...
                            <div class="p-20">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control" name="post_headline"
                                           value="{{$post->post_headline}}" required>
       ...
       --}}
            ...
            <div class="col-3">
                <div class="card-box">
                    <div class="form-group row">
                        <button type="submit" class="btn btn-block w-sm btn-success waves-effect waves-light">Update
                        </button>
                    </div>
                        ...
                        <div class="col-12">
                            <div class="p-20">
                                    ...
                                    <select class="form-control" name="category_id">
                                        @foreach($categories as $category)
                                            <option value="{{$category->category_id}}"
                                                    @if($category->category_id==$post->category_id) selected @endif>{{$category->category_name}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <input type="text" class="form-control "value="{{$post->post_tags}}"  name="post_tags" data-role="tagsinput">
                                ...
                                <div class="form-group row">
                                    ...
                                    <input type="hidden" class="form-control" value="{{$post->post_featured_image}}"
