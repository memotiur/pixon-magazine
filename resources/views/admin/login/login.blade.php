        ...
        <div class="p-20">
            <form class="form-horizontal m-t-20" action="/login-check" method="post">
                <div class="form-group ">
                    <div class="col-12">
                        <input class="form-control" type="text" required="" value="memotiur@gmail.com" name="email" placeholder="Email">
                ...
                <div class="form-group">
                    <div class="col-12">
                        <input class="form-control" type="password" value="123456" required="" name="password" placeholder="Password">
                    </div>
                </div>
                ...
                <div class="form-group m-t-30 m-b-0">
                    <div class="col-12">
                        <a href="/admin/forget-pass" class="text-dark"><i class="fa fa-lock m-r-5"></i> Forgot
                            your password?</a>
                    </div>
                </div>
